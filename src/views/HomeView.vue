...
<template>
  <div class="row">
    <div class="col-md-4 col-sm-12 col-xs-12" :style="$q.screen.sm || $q.screen.xs ? 'height:50vh' : ''">
      <TheLeftPanel></TheLeftPanel>
    </div>
    <div class="col-md col-sm-12 col-xs-12"><the-map></the-map></div>
    <!-- for non mobile devices map tools panel on the right-->
    <!-- mobile devices show menu on upper left map; see map.vue for button-->
