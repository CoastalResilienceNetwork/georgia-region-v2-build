<template>
  <div @click.stop @keypress.stop>
    ...
    <p>Expand the contents to browse layers</p>
    <q-input
      ref="filterRef"
      class="q-mb-md"
      outlined
    ...
    <q-linear-progress v-if="!showTree" dark query color="primary" class="q-mt-sm" />
    <div v-if="showTree">
      <q-tree
        v-if="showTree"
        ref="tree"
        ...
        :filter="filter"
      >
        <template v-slot:default-header="prop" v-if="showTree">
              ...
              >
                <q-card class="">
                  ...
                  <div class="row items-left q-pa-sm">
                    <div class="col-1">
                      <q-icon color="primary" name="opacity" size="xs" />
                    </div>
...
let ticked= layersStore.tree.ticked
let expanded = []
let filter= ''
let filterRef = null
let showTree= false
