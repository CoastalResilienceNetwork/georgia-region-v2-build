import{kH as Q,aB as ta,kG as $e,j4 as Ee,kN as oa,iK as Pa,dy as U,aq as $,na as Ra,bi as me,i0 as ra,kZ as ne,K as s,M as be,$ as Fa,g7 as oe,gM as Da,gQ as je,gT as ja,gR as Va,br as Ba,fP as Ha,ob as Wa,li as Ua,bo as qa,aD as E,b3 as Ya,lI as ka,qG as Za,lq as Ve,kS as Be,af as Xa,as as Ja,an as Ka,cL as Te,du as Qa,dw as He,aF as et,iI as at}from"./index-BpRwgmUh.js";import{H as tt}from"./InterleavedLayout-ODXCKo8d.js";import{n as g,u as ee,t as We,o as Me,r as ot}from"./ShaderOutput-DnYY5J1_.js";import{n as z,a as T,t as he}from"./NormalAttribute.glsl-C7NzajGz.js";import{aO as _e,aZ as h,z as ia,a_ as rt,a$ as it,b0 as G,b1 as nt,b2 as st,b3 as lt,D as se,p as ct,K as dt,q as ut,h as A,an as R,c as j,a2 as V,b4 as B,a4 as K,G as N,a6 as H,au as mt,a5 as ht,b5 as ft,ak as F,b6 as pt,J as na,as as sa,F as la,aX as ca,S as vt,P as ze,Q as fe,I as da,b7 as gt,i as le,aP as xt,T as bt,U as we,R as re,m as ua,o as O,B as Oe,C as ce,l as Tt,b8 as Mt,b9 as wt,L as St,aa as yt,ba as ma,bb as ha,g as de,bc as fa,a3 as pa,a9 as va,a8 as ga,a7 as xa,H as ue,bd as ba,W as Ct,V as Ue,af as Nt,ag as Ot,ah as $t,ai as Et,ab as _t,ac as zt,ad as It,ae as At,aj as Gt,al as P,$ as d,v as Lt,A as Se,am as Pt,az as Rt,x as Ft,d as Dt,ao as jt,y as Vt,aJ as Bt}from"./VerticalOffset.glsl-Dyw-wIg2.js";import{i as I,a as qe,e as ae,n as pe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{B as Ie,g as Ae,f as Ht}from"./renderState-Bv1X_dcr.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{a as Ge}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-CMkq6NbF.js";import{e as Le,o as q}from"./mat3f64-q3fE-ZOt.js";import{o as Ye}from"./mat4f64-Dk4dwAN8.js";import"./boundedPlane-CbW5p-P-.js";import"./sphere-D4NBD6NH.js";import{o as Wt,r as Ut}from"./doublePrecisionUtils-B0owpBza.js";function qt(a){a.vertex.code.add(r`
  ...
  `)}function Qo({normalTexture:a,metallicRoughnessTexture:e,metallicFactor:t,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return a==null&&e==null&&i==null&&(n==null||ta(n,$e))&&c==null&&(o==null||o===1)&&(t==null||t===1)}const Yt=Q(1,1,.5),er=Q(0,.6,.2),ar=Q(0,1,.2);function kt(a){const e=a.fragment.code;e.add(r`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG)
{
...
return c2 * a004 + r.zw;
}`)),e.pbrMode!==h.Normal&&e.pbrMode!==h.Schematic||(a.include(kt),t.add(r`struct PBRShadingInfo
{
float NdotV;
float LdotH;
float NdotNG;
...
return outColor;
}`))}function tr(a,e){const t=a.fragment.code;a.include(_e),t.add(r`
...
}`)}const Zt=3e5,ke=5e5;function Ta(a){a.code.add(r`const float MAX_RGBA4_FLOAT =
15.0 / 16.0 +
15.0 / 16.0 / 16.0 +
15.0 / 16.0 / 16.0 / 16.0 +
...
}`);break;default:Ee(e.doubleSidedMode);case C.COUNT:}}var C;(function(a){a[a.None=0]="None",a[a.View=1]="View",a[a.WindingOrder=2]="WindingOrder",a[a.COUNT=3]="COUNT"})(C||(C={}));function Ma(a,e){switch(e.normalType){case T.Attribute:case T.Compressed:a.include(he,e),a.varyings.add("vNormalWorld","vec3"),a.varyings.add("vNormalView","vec3"),a.vertex.uniforms.add(new it("transformNormalGlobalFromModel",t=>t.transformNormalGlobalFromModel),new G("transformNormalViewFromGlobal",t=>t.transformNormalViewFromGlobal)),a.vertex.code.add(r`void forwardNormal() {
vNormalWorld = transformNormalGlobalFromModel * normalModel();
vNormalView = transformNormalViewFromGlobal * vNormalWorld;
}`);break;case T.ScreenDerivative:a.vertex.code.add(r`void forwardNormal() {}`);break;default:Ee(e.normalType);case T.COUNT:}}let Kt=class extends rt{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Le()}},Qt=class extends nt{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Le(),this.toMapSpace=oa()}};function wa(a){a.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
}`)}}function W(a,e){ao(a,e,new A("textureAlphaCutoff",t=>t.textureAlphaCutoff))}function ao(a,e,t){const o=a.fragment,i=e.alphaDiscardMode,n=i===I.Blend;i!==I.Mask&&i!==I.MaskBlend||o.uniforms.add(t),o.code.add(r`
    void discardOrAdjustAlpha(inout vec4 color) {
      ${i===I.Opaque?"color.a = 1.0;":`if (color.a < ${n?r.float(R):"textureAlphaCutoff"}) {
              discard;
             } ${v(i===I.Mask,"else { color.a = 1.0; }")}`}
    }
  `)}function Ca(a,e){const{vertex:t,fragment:o}=a,i=e.hasColorTexture&&e.alphaDiscardMode!==I.Opaque,{output:n,normalType:c,hasColorTextureTransform:m}=e;switch(n){case g.Depth:j(t,e),a.include(V,e),a.fragment.include(H,e),a.include(B,e),i&&o.uniforms.add(new N("tex",u=>u.texture)),t.main.add(r`vpos = getVertexInLocalOriginSpace();
...
}`))}const ye=4;function Na(){const a=new ve,e=a.fragment;a.include(la);const t=(ye+1)/2,o=1/(2*t*t);return e.include(ca),e.uniforms.add(new N("depthMap",i=>i.depthTexture),new na("tex",i=>i.colorTexture),new vt("blurSize",i=>i.blurSize),new A("projScale",(i,n)=>{const c=n.camera.distance;return c>5e4?Math.max(0,i.projScale-(c-5e4)):i.projScale})),e.code.add(r`
...
return fallOffFunction(vv, vn, 0.1);
}`),e.uniforms.add(new N("normalMap",t=>t.normalTexture),new N("depthMap",t=>t.depthTexture),new A("projScale",t=>t.projScale),new N("rnm",t=>t.noiseTexture),new sa("rnmScale",(t,o)=>ne(Ke,o.camera.fullWidth/t.noiseTexture.descriptor.width,o.camera.fullHeight/t.noiseTexture.descriptor.height)),new A("intensity",t=>t.intensity),new xt("screenSize",t=>ne(Ke,t.camera.fullWidth,t.camera.fullHeight))),a.outputs.add("fragOcclusion","float"),e.main.add(r`
      ...
      fragOcclusion = A;`),a}function ge(a){return Math.max(10,20*a.computeScreenPixelSizeAtDist(Math.abs(4*a.relativeElevation)))}const Ke=ra(),co=Object.freeze(Object.defineProperty({__proto__:null,build:Oa,getRadius:ge},Symbol.toStringTag,{value:"Module"}));let Qe=class extends ze{constructor(e,t){super(e,t,new fe(co,()=>me(()=>Promise.resolve().then(()=>Go),void 0)))}initializePipeline(){return Ie({colorWrite:Ae})}};const J=2;let X=class extends bt{constructor(a){super(a),this.consumes={required:["normals"]},this.produces=we.SSAO,this.isEnabled=()=>!1,this._enableTime=oe(0),this._passParameters=new no,this._drawParameters=new lo}initialize(){const a=Uint8Array.from(atob(ro),t=>t.charCodeAt(0)),e=new Da;e.wrapMode=je.CLAMP_TO_EDGE,e.pixelFormat=ja.RGB,e.wrapMode=je.REPEAT,e.hasMipmap=!0,e.width=32,e.height=32,this._passParameters.noiseTexture=new Va(this.renderingContext,e,a),this.techniques.precompile(Qe),this.techniques.precompile(Xe),this.addHandles(Ba(()=>this.isEnabled(),()=>this._enableTime=oe(0)))}destroy(){this._passParameters.noiseTexture=Ha(this._passParameters.noiseTexture)}render(a){const e=this.bindParameters,t=a.find(({name:y})=>y==="normals"),o=t==null?void 0:t.getTexture(),i=t==null?void 0:t.getTexture(Wa),n=this.fboCache,c=e.camera,m=c.fullViewport[2],u=c.fullViewport[3],p=Math.round(m/J),x=Math.round(u/J),M=this.techniques.get(Qe),w=this.techniques.get(Xe);if(!M.compiled||!w.compiled)return this._enableTime=oe(performance.now()),this.requestRender(qe.UPDATE),n.acquire(p,x,we.SSAO,re.RED);this._enableTime===0&&(this._enableTime=oe(performance.now()));const f=this.renderingContext,L=this.view.qualitySettings.fadeDuration,S=c.relativeElevation,te=qa((ke-S)/(ke-Zt),0,1),Y=L>0?Math.min(L,performance.now()-this._enableTime)/L:1,xe=Y*te;this._passParameters.normalTexture=o,this._passParameters.depthTexture=i,this._passParameters.projScale=1/c.computeScreenPixelSizeAtDist(1),this._passParameters.intensity=4*uo/ge(c)**6*xe;const k=n.acquire(m,u,"ssao input",re.RG);f.bindFramebuffer(k.fbo),f.setViewport(0,0,m,u),f.bindTechnique(M,e,this._passParameters,this._drawParameters),f.screen.draw();const Z=n.acquire(p,x,"ssao blur",re.RED);f.bindFramebuffer(Z.fbo),this._drawParameters.colorTexture=k.getTexture(),ne(this._drawParameters.blurSize,0,J/u),f.bindTechnique(w,e,this._passParameters,this._drawParameters),f.setViewport(0,0,p,x),f.screen.draw(),k.release();const D=n.acquire(p,x,we.SSAO,re.RED);return f.bindFramebuffer(D.fbo),f.setViewport(0,0,m,u),f.setClearColor(1,1,1,0),f.clear(Ua.COLOR),this._drawParameters.colorTexture=Z.getTexture(),ne(this._drawParameters.blurSize,J/m,0),f.bindTechnique(w,e,this._passParameters,this._drawParameters),f.setViewport(0,0,p,x),f.screen.draw(),f.setViewport4fv(c.fullViewport),Z.release(),Y<1&&this.requestRender(qe.UPDATE),D}};s([be()],X.prototype,"consumes",void 0),s([be()],X.prototype,"produces",void 0),s([be({constructOnly:!0})],X.prototype,"isEnabled",void 0),X=s([Fa("esri.views.3d.webgl-engine.effects.ssao.SSAO")],X);const uo=.5;function Re(a,e){const t=a.fragment;e.receiveAmbientOcclusion?(t.uniforms.add(new ua("ssaoTex",o=>{var i;return(i=o.ssao)==null?void 0:i.getTexture()})),t.constants.add("blurSizePixelsInverse","float",1/J),t.code.add(r`float evaluateAmbientOcclusionInverse() {
...
}`))}const ea=$(),_=oa();function Fe(a){a.constants.add("ambientBoostFactor","float",wt)}function De(a){a.uniforms.add(new le("lightingGlobalFactor",e=>e.lighting.globalFactor))}function $a(a,e){const t=a.fragment;switch(a.include(Re,e),e.pbrMode!==h.Disabled&&a.include(Pe,e),a.include(mo,e),a.include(_e),t.code.add(r`
...
}`),e.pbrMode){case h.Disabled:case h.WaterOnIntegratedMesh:case h.Water:a.include(Mt),t.code.add(r`vec3 evaluateSceneLighting(vec3 normalWorld, vec3 albedo, float shadow, float ssao, vec3 additionalLight) {
...
metallicRoughnessUV = (metallicRoughnessTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):a.vertex.code.add(r`void forwardMetallicRoughnessUV(){}`)}function Ia(a){a.include(yt),a.code.add(r`
  ...
  `)}function Aa(a){const e=new ve,{vertex:t,fragment:o,varyings:i}=e,{output:n,normalType:c,offsetBackfaces:m,instancedColor:u,spherical:p,receiveShadows:x,snowCover:M,pbrMode:w,textureAlphaPremultiplied:f,instancedDoublePrecision:L,hasVertexColors:S,hasVertexTangents:te,hasColorTexture:Y,hasNormalTexture:xe,hasNormalTextureTransform:k,hasColorTextureTransform:Z}=a;if(j(t,a),e.include(ma),i.add("vpos","vec3"),e.include(K,a),e.include(Sa,a),e.include(ha,a),e.include(fo,a),!ee(n))return e.include(Ca,a),e;e.include(po,a),e.include(vo,a),e.include(go,a),e.include(xo,a),de(t,a),e.include(he,a),e.include(V,a);const D=c===T.Attribute||c===T.Compressed;return D&&m&&e.include(wa),e.include(to,a),e.include(Ma,a),u&&e.attributes.add(b.INSTANCECOLOR,"vec4"),i.add("vPositionLocal","vec3"),e.include(B,a),e.include(fa,a),e.include(ya,a),e.include(pa,a),t.uniforms.add(new va("externalColor",y=>y.externalColor)),i.add("vcolorExt","vec4"),e.include(ga,a),t.main.add(r`
  ...
  `),e.include($a,a),e.include(Re,a),e.include(W,a),e.include(L?Ea:_a,a),e.fragment.include(H,a),e.include(xa,a),de(o,a),o.uniforms.add(t.uniforms.get("localOrigin"),new ue("ambient",y=>y.ambient),new ue("diffuse",y=>y.diffuse),new A("opacity",y=>y.opacity),new A("layerOpacity",y=>y.layerOpacity)),Y&&o.uniforms.add(new N("tex",y=>y.texture)),e.include(ba,a),e.include(Pe,a),o.include(Ia),e.include(Jt,a),Fe(o),De(o),ce(o),o.main.add(r`
    ...
    ${w===h.Normal||w===h.Schematic?r`
            float additionalAmbientIrradiance = additionalAmbientIrradianceFactor * mainLightIntensity[2];
            ${v(M,r`mrr = mix(mrr, vec3(0.0, 1.0, 0.04), snow);`)}
            vec4 emission = ${M?"mix(getEmissions(), vec4(0.0), snow)":"getEmissions()"};
  ...
  `),e}const bo=Object.freeze(Object.defineProperty({__proto__:null,build:Aa},Symbol.toStringTag,{value:"Module"}));let To=class extends Kt{constructor(){super(...arguments),this.isSchematic=!1,this.usePBR=!1,this.mrrFactors=Yt,this.hasVertexColors=!1,this.hasSymbolColors=!1,this.doubleSided=!1,this.doubleSidedType="normal",this.cullFace=ae.Back,this.isInstanced=!1,this.hasInstancedColor=!1,this.emissiveFactor=$e,this.instancedDoublePrecision=!1,this.normalType=T.Attribute,this.receiveShadows=!0,this.receiveAmbientOcclusion=!0,this.castShadows=!0,this.ambient=Q(.2,.2,.2),this.diffuse=Q(.8,.8,.8),this.externalColor=ka(1,1,1,1),this.colorMixMode="multiply",this.opacity=1,this.layerOpacity=1,this.origin=$(),this.hasSlicePlane=!1,this.offsetTransparentBackfaces=!1,this.vvSize=null,this.vvColor=null,this.vvOpacity=null,this.vvSymbolAnchor=null,this.vvSymbolRotationMatrix=null,this.modelTransformation=null,this.transparent=!1,this.writeDepth=!0,this.customDepthTest=pe.Less,this.textureAlphaMode=I.Blend,this.textureAlphaCutoff=R,this.textureAlphaPremultiplied=!1,this.renderOccluded=Ct.Occlude,this.isDecoration=!1}};class ur extends Qt{constructor(){super(...arguments),this.origin=$(),this.slicePlaneLocalOrigin=this.origin}}let Ga=class extends ze{constructor(e,t,o=new fe(bo,()=>me(()=>Promise.resolve().then(()=>Lo),void 0))){super(e,t,o),this.type="DefaultMaterialTechnique"}_makePipeline(e,t){const{oitPass:o,output:i,transparent:n,cullFace:c,customDepthTest:m,hasOccludees:u,enableOffset:p}=e,x=o===Ue.NONE,M=o===Ue.FrontFace;return Ie({blending:ee(i)&&n?Et(o):null,culling:wo(e)?Ht(c):null,depthTest:{func:$t(o,Mo(m))},depthWrite:Ot(e),drawBuffers:i===g.Depth?{buffers:[Za.NONE]}:Nt(o,i),colorWrite:Ae,stencilWrite:u?At:null,stencilTest:u?t?zt:It:null,polygonOffset:x||M?null:_t(p)})}initializePipeline(e){return this._occludeePipelineState=this._makePipeline(e,!0),this._makePipeline(e,!1)}getPipeline(e){return e?this._occludeePipelineState:super.getPipeline()}};function Mo(a){return a===pe.Lequal?Ve.LEQUAL:Ve.LESS}function wo(a){return a.cullFace!==ae.None||!a.hasSlicePlane&&!a.transparent&&!a.doubleSidedMode}class l extends Gt{constructor(e,t){super(),this.spherical=e,this.doublePrecisionRequiresObfuscation=t,this.alphaDiscardMode=I.Opaque,this.doubleSidedMode=C.None,this.pbrMode=h.Disabled,this.cullFace=ae.None,this.normalType=T.Attribute,this.customDepthTest=pe.Less,this.emissionSource=P.None,this.hasVertexColors=!1,this.hasSymbolColors=!1,this.hasVerticalOffset=!1,this.hasColorTexture=!1,this.hasMetallicRoughnessTexture=!1,this.hasOcclusionTexture=!1,this.hasNormalTexture=!1,this.hasScreenSizePerspective=!1,this.hasVertexTangents=!1,this.hasOccludees=!1,this.hasModelTransformation=!1,this.offsetBackfaces=!1,this.vvSize=!1,this.vvColor=!1,this.receiveShadows=!1,this.receiveAmbientOcclusion=!1,this.textureAlphaPremultiplied=!1,this.instanced=!1,this.instancedColor=!1,this.writeDepth=!0,this.transparent=!1,this.enableOffset=!0,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.snowCover=!1,this.hasColorTextureTransform=!1,this.hasEmissionTextureTransform=!1,this.hasNormalTextureTransform=!1,this.hasOcclusionTextureTransform=!1,this.hasMetallicRoughnessTextureTransform=!1,this.occlusionPass=!1,this.hasVvInstancing=!0,this.useCustomDTRExponentForWater=!1,this.useFillLights=!0}get textureCoordinateType(){return this.hasColorTexture||this.hasMetallicRoughnessTexture||this.emissionSource===P.Texture||this.hasOcclusionTexture||this.hasNormalTexture?F.Default:F.None}get objectAndLayerIdColorInstanced(){return this.instanced}get discardInvisibleFragments(){return this.transparent}}s([d({count:I.COUNT})],l.prototype,"alphaDiscardMode",void 0),s([d({count:C.COUNT})],l.prototype,"doubleSidedMode",void 0),s([d({count:h.COUNT})],l.prototype,"pbrMode",void 0),s([d({count:ae.COUNT})],l.prototype,"cullFace",void 0),s([d({count:T.COUNT})],l.prototype,"normalType",void 0),s([d({count:pe.COUNT})],l.prototype,"customDepthTest",void 0),s([d({count:P.COUNT})],l.prototype,"emissionSource",void 0),s([d()],l.prototype,"hasVertexColors",void 0),s([d()],l.prototype,"hasSymbolColors",void 0),s([d()],l.prototype,"hasVerticalOffset",void 0),s([d()],l.prototype,"hasColorTexture",void 0),s([d()],l.prototype,"hasMetallicRoughnessTexture",void 0),s([d()],l.prototype,"hasOcclusionTexture",void 0),s([d()],l.prototype,"hasNormalTexture",void 0),s([d()],l.prototype,"hasScreenSizePerspective",void 0),s([d()],l.prototype,"hasVertexTangents",void 0),s([d()],l.prototype,"hasOccludees",void 0),s([d()],l.prototype,"hasModelTransformation",void 0),s([d()],l.prototype,"offsetBackfaces",void 0),s([d()],l.prototype,"vvSize",void 0),s([d()],l.prototype,"vvColor",void 0),s([d()],l.prototype,"receiveShadows",void 0),s([d()],l.prototype,"receiveAmbientOcclusion",void 0),s([d()],l.prototype,"textureAlphaPremultiplied",void 0),s([d()],l.prototype,"instanced",void 0),s([d()],l.prototype,"instancedColor",void 0),s([d()],l.prototype,"writeDepth",void 0),s([d()],l.prototype,"transparent",void 0),s([d()],l.prototype,"enableOffset",void 0),s([d()],l.prototype,"terrainDepthTest",void 0),s([d()],l.prototype,"cullAboveTerrain",void 0),s([d()],l.prototype,"snowCover",void 0),s([d()],l.prototype,"hasColorTextureTransform",void 0),s([d()],l.prototype,"hasEmissionTextureTransform",void 0),s([d()],l.prototype,"hasNormalTextureTransform",void 0),s([d()],l.prototype,"hasOcclusionTextureTransform",void 0),s([d()],l.prototype,"hasMetallicRoughnessTextureTransform",void 0);function La(a){const e=new ve,{vertex:t,fragment:o,varyings:i}=e,{output:n,offsetBackfaces:c,instancedColor:m,pbrMode:u,snowCover:p,spherical:x}=a,M=u===h.Normal||u===h.Schematic;if(j(t,a),e.include(ma),i.add("vpos","vec3"),e.include(K,a),e.include(Sa,a),e.include(ha,a),e.include(ga,a),ee(n)&&(de(e.vertex,a),e.include(he,a),e.include(V,a),c&&e.include(wa),m&&e.attributes.add(b.INSTANCECOLOR,"vec4"),i.add("vNormalWorld","vec3"),i.add("localvpos","vec3"),e.include(B,a),e.include(fa,a),e.include(ya,a),e.include(pa,a),t.uniforms.add(new va("externalColor",w=>w.externalColor)),i.add("vcolorExt","vec4"),t.main.add(r`
    ...
    `)),ee(n)){const{hasColorTexture:w,hasColorTextureTransform:f,receiveShadows:L}=a;e.include($a,a),e.include(Re,a),e.include(W,a),e.include(a.instancedDoublePrecision?Ea:_a,a),e.fragment.include(H,a),e.include(xa,a),de(e.fragment,a),Oe(o),Fe(o),De(o),o.uniforms.add(t.uniforms.get("localOrigin"),t.uniforms.get("view"),new ue("ambient",S=>S.ambient),new ue("diffuse",S=>S.diffuse),new A("opacity",S=>S.opacity),new A("layerOpacity",S=>S.layerOpacity)),w&&o.uniforms.add(new N("tex",S=>S.texture)),e.include(ba,a),e.include(Pe,a),o.include(Ia),ce(o),o.main.add(r`
      discardBySlice(vpos);
      discardByTerrainDepth();
      vec4 texColor = ${w?`texture(tex, ${f?"colorUV":"vuv0"})`:" vec4(1.0)"};
      ${v(w,`${v(a.textureAlphaPremultiplied,"texColor.rgb /= texColor.a;")}
        discardOrAdjustAlpha(texColor);`)}
      ...
      ${v(M,`vec3 normalGround = ${x?"normalize(vpos + localOrigin)":"vec3(0.0, 0.0, 1.0)"};`)}
      ${M?r`float additionalAmbientIrradiance = additionalAmbientIrradianceFactor * mainLightIntensity[2];
